...
public class NEEDMOREINFO_test extends BASEclass {
	Homepage homepage ;
	Homepage logout;
	...
	@Test(groups="smoke")
	public void  needmorefunctionfunction() throws Throwable {
		 homepage = new Homepage();
		 editticketz =homepage.agentticketpage();
	     //Thread.sleep(2222);
	   editticketz.editthetickets();
		logout=editticketz.need("i need more clearifications on this ticket");
	}
}
